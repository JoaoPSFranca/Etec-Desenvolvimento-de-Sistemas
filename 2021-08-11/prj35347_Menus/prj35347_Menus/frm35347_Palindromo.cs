...
namespace prj35347_Palindromo
{
    public partial class frm35347_Palindromo : Form
    {
        ...
        //#region FormClosing
        //private void frm35347_Palindromo_FormClosing(object sender, FormClosingEventArgs e)
        //{
        //    if (MessageBox.Show("Deseja Sair?", "Palíndromo", MessageBoxButtons.YesNo, MessageBoxIcon.Question, MessageBoxDefaultButton.Button2) == DialogResult.No)
        //    {
        //        e.Cancel = true;
        //    }
        //}
